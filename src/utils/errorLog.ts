// ثبت خطاهای فرانت‌اند — سبک، بی‌صدا، بدون داده حساس
...
//
// اصول:
//   • fire-and-forget و کاملاً بی‌صدا (هرگز تجربه کاربر را مختل نمی‌کند)
//   • فیلتر داده حساس (شماره موبایل/کارت/شبا/ایمیل/توکن) قبل از ارسال
...
export function initErrorLogging(): void {
  try {
    ...
    // بعد از هر دیپلوی، هش نام چانک‌های lazy تغییر می‌کند؛ مرورگری که نسخه قدیمی را
