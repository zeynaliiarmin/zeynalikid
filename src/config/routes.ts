...
export const SYSTEM_REFERRAL_PATHS=new Set([
 'admin','admin-login','desk','desk/app','courses','experience','education','about','contact','faq','products','form','consultation','portal','growth','settings','profile','privacy','licenses','child-info','course-shipping','course-payment','course-confirm','course-done','payment-verify',
]);
