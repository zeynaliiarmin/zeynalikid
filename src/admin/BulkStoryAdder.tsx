// کامپوننت «افزودن دسته‌جمعی استوری» — در ماژول مستقل (خارج از بدنه AdminPanel)
// ⚠️ تعریف این کامپوننت داخل بدنه AdminPanel باعث می‌شد با هر رندر مجدد پنل، هویت
...
//
// متن فیلدها به‌صورت کنترل‌شده از والد (سطح AdminPanel) می‌آید تا دکمه «ذخیره هایلایت‌ها»
