/**
 * Zeynalikid Admin — دکمهٔ تغییر تم (وایت/دارک مود) هدر پنل مدیریت
 * بازطراحی با الهام از نمونهٔ «change theme button»:
 *  • کپسول لغزنده با «صورت» خورشید/ماه که با چرخش و محو نرم جابه‌جا می‌شود.
 *  • در حالت تیره: هالهٔ نیلی نرم + ستاره‌های چشمک‌زن داخل کپسول.
