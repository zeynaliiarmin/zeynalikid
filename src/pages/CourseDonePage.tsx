...
export default function CourseDonePage(){
 ...
 return <div style={S.page}><Helmet><title>{`ثبت‌نام دوره | ${brand}`}</title><meta name="description" content="تکمیل ثبت‌نام دوره تخصصی رشد و تغذیه کودکان و نوجوانان" /><meta name="robots" content="noindex, follow" /></Helmet><style>{css}</style><div style={{...S.card,maxWidth:460,textAlign:'center',padding:'20px 18px'}}>
  <div style={{margin:'2px auto 12px',width:78,height:78,borderRadius:'50%',background:'linear-gradient(135deg,#10b981,#06b6d4)',display:'flex',alignItems:'center',justifyContent:'center',boxShadow:'0 16px 38px rgba(16,185,129,.3), 4px 4px 10px rgba(0,0,0,.08)',animation:'modalIn .4s ease both'}}><svg width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="#04111B" strokeWidth="2.8" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6 9 17l-5-5"/></svg></div>
