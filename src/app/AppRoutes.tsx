...
const ChildInfoPage = lazyWithRetry(() => import('../pages/ChildInfoPage'));
const CourseShippingPage = lazyWithRetry(() => import('../pages/CourseShippingPage'));
const CoursePaymentPage = lazyWithRetry(() => import('../pages/CoursePaymentPage'));
const PaymentVerifyPage = lazyWithRetry(() => import('../pages/PaymentVerifyPage'));
const CourseConfirmPage = lazyWithRetry(() => import('../pages/CourseConfirmPage'));
const CourseDonePage = lazyWithRetry(() => import('../pages/CourseDonePage'));
...
const ExperiencePage = lazyWithRetry(() => import('../pages/InfoPages').then((module) => ({ default: module.ExperiencePage })));
const LicensesPage = lazyWithRetry(() => import('../pages/InfoPages').then((module) => ({ default: module.LicensesPage })));
const EducationPage = lazyWithRetry(() => import('../pages/InfoPages').then((module) => ({ default: module.EducationPage })));
const AboutPage = lazyWithRetry(() => import('../pages/InfoPages').then((module) => ({ default: module.AboutPage })));
const ContactPage = lazyWithRetry(() => import('../pages/InfoPages').then((module) => ({ default: module.ContactPage })));
const FAQPage = lazyWithRetry(() => import('../pages/FAQPage'));
const ProductsPage = lazyWithRetry(() => import('../pages/ProductsPage'));
const UserPortalPage = lazyWithRetry(() => import('../pages/UserPortalPage'));
const ConsultationPage = lazyWithRetry(() => import('../pages/ConsultationPage'));
const GrowthChartPage = lazyWithRetry(() => import('../pages/GrowthChartPage'));
