...
const css=`@keyframes fade{from{opacity:0}to{opacity:1}}@keyframes fadeSlide{from{opacity:0;transform:translateY(12px)}to{opacity:1;transform:translateY(0)}}@keyframes modalIn{from{opacity:0;transform:translateY(20px) scale(.96)}to{opacity:1;transform:translateY(0) scale(1)}}@keyframes floatSoft{0%,100%{transform:translateY(0)}50%{transform:translateY(-10px)}}@keyframes zk-hero-pulse{0%,100%{transform:scale(1);box-shadow:0 0 0 0 rgba(15,118,110,.35)}50%{transform:scale(1.05);box-shadow:0 0 0 12px rgba(15,118,110,0)}}@-webkit-keyframes fadeSlide{from{opacity:0;-webkit-transform:translateY(12px)}to{opacity:1;-webkit-transform:translateY(0)}}@-webkit-keyframes modalIn{from{opacity:0;-webkit-transform:translateY(20px) scale(.96)}to{opacity:1;-webkit-transform:translateY(0) scale(1)}}@-webkit-keyframes zk-hero-pulse{0%,100%{-webkit-transform:scale(1);box-shadow:0 0 0 0 rgba(15,118,110,.35)}50%{-webkit-transform:scale(1.05);box-shadow:0 0 0 12px rgba(15,118,110,0)}}@-webkit-keyframes zk-menu-pulse{0%,100%{box-shadow:0 0 0 0 rgba(15,118,110,.4)}50%{box-shadow:0 0 0 8px rgba(15,118,110,0)}}@keyframes zk-ring-spin{from{transform:rotate(0deg)}to{transform:rotate(360deg)}}@-webkit-keyframes zk-ring-spin{from{-webkit-transform:rotate(0deg)}to{-webkit-transform:rotate(360deg)}}@keyframes zk-story-in{from{opacity:0;transform:scale(.96) translateY(6px)}to{opacity:1;transform:scale(1) translateY(0)}}@-webkit-keyframes zk-story-in{from{opacity:0;-webkit-transform:scale(.96) translateY(6px)}to{opacity:1;-webkit-transform:scale(1) translateY(0)}}@keyframes zk-story-slide{from{opacity:0;transform:translateX(16px)}to{opacity:1;transform:translateX(0)}}@-webkit-keyframes zk-story-slide{from{opacity:0;-webkit-transform:translateX(16px)}to{opacity:1;-webkit-transform:translateX(0)}}@keyframes zk-story-hl-next{from{opacity:0;transform:translateX(64px)}to{opacity:1;transform:translateX(0)}}@-webkit-keyframes zk-story-hl-next{from{opacity:0;-webkit-transform:translateX(64px)}to{opacity:1;-webkit-transform:translateX(0)}}@keyframes zk-story-hl-prev{from{opacity:0;transform:translateX(-64px)}to{opacity:1;transform:translateX(0)}}@-webkit-keyframes zk-story-hl-prev{from{opacity:0;-webkit-transform:translateX(-64px)}to{opacity:1;-webkit-transform:translateX(0)}}@keyframes zk-hint-pulse{0%,100%{opacity:.55;transform:scale(1)}50%{opacity:1;transform:scale(1.15)}}@-webkit-keyframes zk-hint-pulse{0%,100%{opacity:.55;-webkit-transform:scale(1)}50%{opacity:1;-webkit-transform:scale(1.15)}}@keyframes zk-story-out{from{opacity:1;transform:translateY(0) scale(1)}to{opacity:0;transform:translateY(45vh) scale(.9)}}@-webkit-keyframes zk-story-out{from{opacity:1;-webkit-transform:translateY(0) scale(1)}to{opacity:0;-webkit-transform:translateY(45vh) scale(.9)}}.zk-pulse{-webkit-animation:zk-hero-pulse 1.6s ease-in-out infinite;animation:zk-hero-pulse 1.6s ease-in-out infinite}*{box-sizing:border-box}button,button:active,button:focus{color:inherit;-webkit-tap-highlight-color:transparent;outline:none;-webkit-appearance:none}button:hover{filter:brightness(1.035)}button:active{transform:scale(.98)}input,textarea,select{font-size:16px!important}a,a:visited,a:active,a:focus{color:inherit;text-decoration:none}button:focus,a:focus{outline:none}button::-moz-focus-inner{border:0} @media(max-width:520px){body{margin:0} }`;
export default App;
