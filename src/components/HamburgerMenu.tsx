...
import { MenuIcon, HomeIcon, ConsultIcon, CoursesIcon, VideoIcon, LicensesIcon, EducationIcon, AboutIcon, ContactIcon, FAQIcon, ProductsIcon } from './Icons';
...
export default function HamburgerMenu({T,lang,setLang,cfg,publicText,APP_A_URL,setView,referralConsultant,referralTarget,findTabByCode,onCoursesClick,onConsultClick}:Props){
 ...
 const portalEntryLabel=lang==='en'
   ?(portalSignedIn?'Parent panel':'Parent sign in')
   :(portalSignedIn?'پنل والد':'ورود والد');
 const itemsBase:Record<string,{label:string; icon:React.ReactNode; to?:string; fn?:()=>void; separator?:boolean}>=Object.fromEntries([
  ...
  ['profile',{label: portalEntryLabel, icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={T.acc} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>, to:'/profile', separator: true}],
