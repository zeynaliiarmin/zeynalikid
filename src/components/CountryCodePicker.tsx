...
// یک پیاده‌سازی مشترک که هم در فرم مشاوره و هم در پنل کاربر / صفحه پیگیری استفاده می‌شود
