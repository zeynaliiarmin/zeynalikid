...
export const EDU_SAMPLES: EduItem[] = [
  {
    ...
    quote: 'سفرهٔ آرام، تمرین کوچکِ هر روز است؛ نه میدان جنگ.',
  ...
  },
  {
    ...
    quote: 'خوابِ کافی، زمینهٔ آرامِ یادگیری است.',
    body: 'تمرکز در کلاس درس از شبِ قبل شروع می‌شود. کودکی که ساعت خواب نامنظم دارد، صبح با ذخیرهٔ کمترِ توجه بیدار می‌شود، حتی اگر صبحانهٔ خوبی خورده باشد.\n\nیک روتین لازم نیست پیچیده باشد: ساعت ثابت خواب، نور کم‌تر در یک ساعت پایانی، و یک فعالیت آرام مثل کتاب خواندنِ مشترک. تکرارِ همین سه قدم، سیگنال امنی برای بدن کودک می‌سازد.\n\nاگر بی‌قراری شبانه یا خستگی روزانه ادامه داشت، به‌جای راه‌حل‌های عمومی، مشورت تخصصی مسیر درست‌تری است؛ چون الگوی خواب هر کودک می‌تواند ریشهٔ متفاوتی داشته باشد.',
  },
  {
    id: 's-v1', type: 'video',
    title: 'آشنایی با نگاه TC به تغذیه؛ از مشاهده تا همراهی',
    titleEn: 'Introduction to the TC view on nutrition',
    desc: 'ویدیوی کوتاه دربارهٔ اینکه در روش TC ابتدا چه چیزهایی بررسی می‌شود.',
  ...
  {
    id: 's-v2', type: 'video',
    title: 'تنوع غذایی بدون جنگ؛ ۵ ایدهٔ کوچک برای سفره',
  ...
  {
    id: 's-p1', type: 'audio',
    title: 'پادکست: افسانه‌های رایج دربارهٔ اشتهای کودک',
    titleEn: 'Podcast: common myths about appetite',
    desc: 'گفت‌وگوی کوتاه دربارهٔ باورهای رایج پیرامون اشتها و اینکه کدام‌یک پشتوانه ندارد.',
  ...
  },
  {
    ...
    desc: 'گفت‌وگو دربارهٔ نقش ژنتیک، خواب و تغذیه در رشد قد — بدون وعده‌های بزرگ.',
...
export const FAQ_SAMPLES: FaqSample[] = [
  { id: 'f1', q: 'آیا مکمل‌ها برای همهٔ سنین مناسب‌اند؟', a: 'خیر؛ نیاز هر کودک متفاوت است و مکمل باید بر اساس شرایط همان کودک انتخاب شود. به همین دلیل ما پیش از هر پیشنهادی، شرایط فرزند شما را بررسی می‌کنیم. هرگز بدون مشورت، مکملی را شروع یا تغییر ندهید.' },
  ...
  { id: 'f4', q: 'آیا بررسی زبان کودک واقعاً بی‌خطر است؟', a: 'بله؛ این بررسی فقط یک مشاهدهٔ ظاهری برای آشنایی با الگوی مزاج و گوارش است و هیچ مداخله یا آزمایشی ندارد. نتیجهٔ آن به‌تنهایی مبنای تصمیم نیست و فقط سرنخ‌های اولیه به مشاور می‌دهد.' },
  ...
  { id: 'f6', q: 'برنامهٔ تغذیه چطور برای فرزند من شخصی‌سازی می‌شود؟', a: 'با اطلاعات سن، قد، وزن، الگوی اشتها، خواب و گوارش که در فرم ثبت می‌کنید، برنامهٔ مخصوص همان کودک تنظیم و در طول دوره بر اساس پیگیری‌ها اصلاح می‌شود.' },
  ...
  { id: 'f9', q: 'کودکم میان‌وعدهٔ شیرینی زیاد می‌خواهد؛ چه کنم؟', a: 'حذف ناگهانی معمولاً جواب نمی‌دهد؛ جایگزین‌های ساده در دسترس و زمان‌بندی منظمِ وعده‌ها کمک می‌کند میل به شیرینی به‌مرور متعادل شود. در مشاوره، ایده‌های متناسب با طبع کودک پیشنهاد می‌شود.' },
  { id: 'f10', q: 'آیا برای نوجوان ۱۵-۱۷ ساله هم برنامه دارید؟', a: 'بله؛ بازهٔ همراهی ما ۲ تا ۱۷ سال است و برای نوجوانان، برنامه با توجه به الگوی رشد و سبک زندگی مدرسه‌ای/ورزشی همان نوجوان تنظیم می‌شود.' },
];
