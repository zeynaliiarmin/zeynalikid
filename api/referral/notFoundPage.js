...
const icons={
 ...
 consult:icon('<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/>'),
 courses:icon('<rect x="5" y="2" width="14" height="20" rx="2"/><line x1="12" y1="18" x2="12.01" y2="18"/>'),
 experience:icon('<polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2" ry="2"/>'),
 licenses:icon('<path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"/>'),
 education:icon('<path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/>'),
 contact:icon('<path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/>'),
};

const shortcuts=[
 ['/consultation','درخواست مشاوره','pink',icons.consult],
 ['/courses','معرفی دوره‌ها','blue',icons.courses],
 ['/experience','تجربه والدین','yellow',icons.experience],
 ['/licenses','مجوزها و نمادها','violet',icons.licenses],
 ['/education','مقالات آموزشی','green',icons.education],
 ['/contact','ارتباط با ما و پشتیبانی','orange',icons.contact],
];
const shortcut=([href,label,tone,svg])=>`<a class="nf-shortcut nf-control tone-${tone}" href="${href}" aria-label="رفتن به ${label}"><strong>${label}</strong><span class="nf-shortcut-icon">${svg}</span></a>`;
...
const styles=`
@font-face{font-family:'Vazirmatn';src:url('/fonts/404-vazirmatn-500.woff2') format('woff2');font-style:normal;font-weight:500;font-display:swap}
@font-face{font-family:'Vazirmatn';src:url('/fonts/404-vazirmatn-700.woff2') format('woff2');font-style:normal;font-weight:700;font-display:swap}
@font-face{font-family:'Vazirmatn';src:url('/fonts/404-vazirmatn-800.woff2') format('woff2');font-style:normal;font-weight:800;font-display:swap}
...
html[data-theme='dark']{color-scheme:dark;background:#0F1722}
html[data-theme='dark'] body{background:#0F1722}
html[data-theme='dark'] .nf-page{background:linear-gradient(180deg,#0F1722 0%,#111827 52%,#1E293B 100%);color:#E2E8F0}
html[data-theme='dark'] .nf-shell{background:#1E293B;border:1px solid #334155;box-shadow:0 20px 44px rgba(0,0,0,.36)}
html[data-theme='dark'] .home-icon,html[data-theme='dark'] .brand{background:#111827;border-color:#475569;color:#E2E8F0;box-shadow:0 1px 2px rgba(0,0,0,.24)}
html[data-theme='dark'] .brand-mark{background:#2DD4BF}
html[data-theme='dark'] .nf-art text{fill:#E2E8F0;stroke:#475569;filter:none}
html[data-theme='dark'] .nf-art circle[fill='none']{stroke:#475569}
html[data-theme='dark'] .exclaim{color:#FCA5A5}
html[data-theme='dark'] .question{color:#E2E8F0}
html[data-theme='dark'] .copy p{color:#B0BED1}
html[data-theme='dark'] .nf-shortcut{--nf-icon-bg:rgba(45,212,191,.12);--nf-icon-color:#5EEAD4;background:#111827;border-color:#475569;color:#E2E8F0;box-shadow:0 2px 8px rgba(0,0,0,.22)}
...
html[data-theme='dark'] .primary{background:#2DD4BF;box-shadow:0 10px 20px rgba(45,212,191,.18);color:#0F1722!important}
html[data-theme='dark'] .home-icon:active,html[data-theme='dark'] .nf-shortcut:active{background:#26364A}
html[data-theme='dark'] .nf-shortcut:active .nf-shortcut-icon{background:#26364A}
html[data-theme='dark'] .primary:active{background:#5EEAD4;color:#0F1722!important}
html[data-theme='dark'] .home-icon:focus-visible,html[data-theme='dark'] .nf-shortcut:focus-visible{box-shadow:0 0 0 3px rgba(45,212,191,.28)}
html[data-theme='dark'] .primary:focus-visible{box-shadow:0 10px 20px rgba(45,212,191,.18),0 0 0 3px rgba(45,212,191,.28)}
`;
