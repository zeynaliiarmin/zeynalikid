...
requireText(static404,'zk_design_system','static 404 does not follow the selected design');
requireText(static404,'public-settings','static 404 does not follow panel design settings');
