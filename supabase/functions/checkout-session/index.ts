...
serve(async(req)=>{
 ...
 // بررسی امنیتی (کپچا) فقط روی فرم ورود/ثبت‌نام والد در /profile انجام می‌شود؛
 // اینجا تکرار نمی‌شود. محافظت این مسیر با محدودیت نرخِ سراسری (centralRateLimit) است.
