...
function buildPrompt(p: any): { prompt: string; allowSport: boolean } {
  ...
  const facts: string[] = [];
  // حریمِ شخصی: هیچ نامی (نه نام کودک و نه نام والد) واردِ برنامه نمی‌شود؛
  // نه در متنِ تولیدی و نه در فایل PDF. نام در برنامه کاربردی هم ندارد و اگر
  // نامِ کودک ثبت نشده بود، نامِ والد جایگزین می‌شد که اشتباه بود.
  ...
  const prompt = [
    ...
    "۹) هرگز هیچ نامی (نه نام کودک و نه نام والد/سرپرست) در آغاز یا درون برنامه‌ها ننویس؛ برنامه را بدون نام و با خطابِ کلی (مانند «والد گرامی») بنویس.",
