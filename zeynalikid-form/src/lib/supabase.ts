...
// ===== ثبت بازدید صفحه (page_views) — اصلاح جدید =====
// اصلاح ۳۱: همان سیستم آمار بازدید پروژه اصلی؛ فقط ثبت (Insert) در همین پروژه لازم است،
// نمایش آمار در پنل مدیریت (پروژه اصلی) انجام می‌شود چون هر دو پروژه به یک دیتابیس Supabase وصل هستند.
// بی‌صدا و بسیار سبک — هرگز نباید در تجربهٔ کاربری فرم مشاوره اختلال ایجاد کند.
