...
function PlatformIcon({type,color,size=18}:{type:string,color:string,size?:number}){const paths:Any={
  ...
  rubika:'M12 2 22 8.5v7L12 22 2 15.5v-7L12 2zm0 3.5L5.5 9.75v4.5L12 18.5l6.5-4.25v-4.5L12 5.5z',
  bale:'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 14.5h-2v-9h2v9zm4 0h-2v-9h2v9z'
};
