...
<div style={{marginTop:12}}><label style={S.lbl}>{lang === 'fa' ? 'یادداشت صوتی برای مشاور (اختیاری)' : 'Voice note for consultant (optional)'}</label><VoiceRecorder T={T} lang={lang} onRecorded={(blob:any)=>{setVoiceBlob(blob)}} onRemoved={()=>{setVoiceBlob(null)}}/></div>
