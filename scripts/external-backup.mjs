...
const tables=['settings','submissions','reviews','user_questions','page_views','error_logs','admin_devices','admin_sessions','security_rate_limits','admin_credentials','admin_audit_logs','submission_contacts','submission_orders','submission_consultations','checkout_sessions','assistant_knowledge','assistant_admin_knowledge','assistant_settings','assistant_unanswered','assistant_question_clusters','assistant_feedback','assistant_bot_states'];
